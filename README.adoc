...
image::rsm_splash.png[splash,180,320]
...
image::rsm_login.png[Login,180,320]
...
image::rsm_call.png[Arama,180,320]
...
image::rsm_diger.png[diger aramalar,180,320]
...
image::rsm_kullanici.png[kullanici,180,320]
...
image::rsm_birimekle.png[birim,180,320]
